...
use Acme\Application\Blog\Command\Post\Handler\UnfavoritePostHandler;
...
class UnfavoritePostHandlerTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @return UnfavoritePostHandler
     */
    private function handler()
    {
        return new UnfavoritePostHandler(
    ...
    public function it_ask_repository_for_creation_and_dispatch_to_event_bus()
    {
        ...
        $eventAssertions = Argument::allOf(
            Argument::type(PostUnfavorited::class),
