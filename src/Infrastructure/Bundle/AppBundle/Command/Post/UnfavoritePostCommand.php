...
class UnfavoritePostCommand extends AbstractPostCommand
{
    /**
     * @inheritDoc
     */
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        if (($post = $input->getArgument('post')) !== null) {
            ...
            $post = $this->askPost($input, $output, 'Which post do you will to unfavorite ?');
        }
